...
hypothesis = st.sidebar.radio("Select a hypothesis:", [
    "Hypothesis1: Technology products have the highest profit margin compared to other product categories.",
    ...
    "Hypothesis5: The company's profit is more on weekdays than on weekends."])

# Main page
st.title("Superstore Sales Dashboard")

# Hypothesis 1
if hypothesis == "Hypothesis1: Technology products have the highest profit margin compared to other product categories.":
...
# Hypothesis 2
elif hypothesis == "Hypothesis2: The East region has the highest sales compared to other regions.":
...
# Hypothesis 3
elif hypothesis == "Hypothesis3: Sales are higher during certain months of the year.":
...
# Hypothesis 4
elif hypothesis == "Hypothesis4: Orders with same-day shipping have the lowest rate of returned products.":
...
elif hypothesis == "Hypothesis5: The company's profit is more on weekdays than on weekends.":
